...
public:
    ...
    void insert(FwdIteratorT _begin, FwdIteratorT _end)
    {
    ...
    void insert(FwdIteratorT _begin, FwdIteratorT _end, OutputIteratorT out)
    {
        for (; _begin != _end; ++_begin, ++out)
            *out = this->insert(*_begin);
    }
