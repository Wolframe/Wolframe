    ...
    public bsc::grammar< filter_grammar< CharT > >
{
    ...
    void on_negation(const char_type* begin UNUSED, const char_type* end UNUSED) const
    {
        make_has_attr();
        if (!m_Subexpressions.empty())
        {
    ...
    void on_comparison_relation(const char_type* begin UNUSED, const char_type* end UNUSED, comparison_relation_handler_t method) const
    {
    ...
    void on_custom_relation(const char_type* begin UNUSED, const char_type* end UNUSED) const
    {
    ...
    void on_operation(const char_type* begin UNUSED, const char_type* end UNUSED) const
    {
        if (!m_Subexpressions.empty())
        {
    ...
    void on_expression_finished(const char_type* begin UNUSED, const char_type* end UNUSED) const
    {
        make_has_attr();
    }
