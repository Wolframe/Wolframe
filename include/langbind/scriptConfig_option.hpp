...
************************************************************************/
///\file langbind/scriptConfig_option.hpp
///\brief Data structures on command line for the configuration of the processor environment
#ifndef _Wolframe_SCRIPT_CMDLINE_OPTION_STRUCT_HPP_INCLUDED
#define _Wolframe_SCRIPT_CMDLINE_OPTION_STRUCT_HPP_INCLUDED
