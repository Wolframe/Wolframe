...
// 4) UTF8   (see http://de.wikipedia.org/wiki/UTF-8 for algorithms)
// 5) UTF16  (little or big endian, no implicit BOM swapping) see http://en.wikipedia.org/wiki/UTF-16/UCS-2 for algorithms)
///
namespace charset {
