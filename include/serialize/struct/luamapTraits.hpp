...
struct has_description_method_noprm
{
	...
	template<const LuamapDescriptionBase* (T::*)()> struct tester_member_signature;
	template<const LuamapDescriptionBase* (*)()> struct tester_static_signature;

	template<typename U>
	static small_type has_matching_member(tester_member_signature<&U::getLuamapDescription>*);
	template<typename U>
	static small_type has_matching_member(tester_static_signature<&U::getLuamapDescription>*);
	template<typename U>
	static large_type has_matching_member(...);

	///\brief value with the boolean property corresponding has getLuamapDescription static/member method without paramater
