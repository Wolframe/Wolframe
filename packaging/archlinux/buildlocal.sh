...
export WOLFRAME_TESTREPORT_DIR=$PKGBUILD/BUILD/wolframe/src/wolframe-$VERSION/tests/reports/
export GTEST_OUTPUT=xml:$PKGBUILD/BUILD/wolframe/src/wolframe-$VERSION/tests/reports/
