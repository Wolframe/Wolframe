...
--input-filter xml:libxml2 --output-filter xml:libxml2 --module ../../src/modules/filter/libxml2/mod_filter_libxml2  --module ../wolfilter/modules/database/testtrace/mod_db_testtrace --database 'id=testdb,outfile=DBOUT,file=DBRES,program=DBIN' test_transaction
