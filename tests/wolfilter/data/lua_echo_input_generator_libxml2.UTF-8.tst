...
--input-filter xml:libxml2 --output-filter xml:libxml2 --module ../../src/modules/cmdbind/luaCommandHandler/mod_lua_command_handler --module ../../src/modules/filter/libxml2/mod_filter_libxml2 --script echo_input_generator.lua run
