...
--input-filter xml:textwolf --output-filter xml:textwolf --module ../wolfilter/modules//employee_assignment_convert//mod_employee_assignment_convert employee_assignment_convert
**output
<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
