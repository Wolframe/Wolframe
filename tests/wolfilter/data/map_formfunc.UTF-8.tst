...
--input-filter textwolf --output-filter textwolf --module ../../src/modules/filter/textwolf/mod_filter_textwolf --module ../../src/modules/doctype/xml/mod_doctype_xml --module ../wolfilter/modules//employee_assignment_convert//mod_employee_assignment_convert employee_assignment_convert
**requires:TEXTWOLF
**output
<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
