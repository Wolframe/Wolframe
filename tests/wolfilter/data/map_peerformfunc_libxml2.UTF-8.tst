...
--input-filter xml:libxml2 --output-filter xml:libxml2 --form employee_assignment_print.simpleform --function transaction:echo_peer:employee_assignment_print:employee_assignment_print transaction
