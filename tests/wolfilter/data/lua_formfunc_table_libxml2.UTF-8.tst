...
--input-filter xml:libxml2 --output-filter xml:libxml2 --module ../wolfilter/modules//employee_assignment_convert//mod_employee_assignment_convert --script formfunc_table.lua run
