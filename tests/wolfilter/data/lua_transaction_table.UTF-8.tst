...
--input-filter xml:textwolf --output-filter xml:textwolf --module ../../src/modules/cmdbind/luaCommandHandler/mod_lua_command_handler --module ../../src/modules/filter/textwolf/mod_filter_textwolf  --module ../../src/modules/transaction//preparedStatement/mod_transaction_pstm --script transaction_table.lua run
