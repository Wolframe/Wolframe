...
--input-filter xml:textwolf --output-filter xml:textwolf --module ../../src/modules/cmdbind/lua/mod_command_lua --module ../../src/modules/filter/textwolf/mod_filter_textwolf  --module ../../src/modules/ddlcompiler//simpleform/mod_ddlcompiler_simpleform --module ../../src/modules/normalize//number/mod_normalize_number --normalize 'int number integer(10)' --normalize 'uint number unsigned(10)' --normalize 'float number float(10,10)' --program employee_assignment_print.simpleform --program ddlform_iterator.lua run
**file: ddlform_iterator.lua
