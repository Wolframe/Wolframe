...
--input-filter xml:libxml2 --output-filter employee_assignment_print_map --module ../../src/modules/filter/libxml2/mod_filter_libxml2 --program employee_assignment_print_map.xslt - 
