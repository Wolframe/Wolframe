...
--input-filter xml:textwolf --output-filter xml:textwolf --form employee_assignment_print.simpleform --function transaction:echo_peer:employee_assignment_print:employee_assignment_print transaction
