...
--input-filter xml:textwolf --output-filter xml:textwolf --module ../../src/modules/ddlcompiler//simpleform/mod_ddlcompiler_simpleform --form employee_assignment_print.simpleform --script ddlform_iterator_scope.lua run
