...
--input-filter xml:textwolf --output-filter xml:textwolf --module ../wolfilter/modules//employee_assignment_convert//mod_employee_assignment_convert.so --script formfunc_table.lua run
