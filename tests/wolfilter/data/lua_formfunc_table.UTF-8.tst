...
--input-filter xml:textwolf --output-filter xml:textwolf --module ../../src/modules/cmdbind/lua/mod_command_lua --module ../../src/modules/filter/textwolf/mod_filter_textwolf --module ../wolfilter/modules//employee_assignment_convert//mod_employee_assignment_convert --script formfunc_table.lua run
