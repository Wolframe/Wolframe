...
LoadModules	{						; modules to be loaded by the server
	module ../wolfilter/modules/database/sqlite3/mod_db_sqlite3test.so
	module ../../src/modules/normalize/number/mod_normalize_number.so
	module ../../src/modules/cmdbind/directmap/mod_command_directmap.so
	module ../../src/modules/audit/database/mod_audit_database.so
	module ../../src/modules/audit/textfile/mod_audit_textfile.so
	module ../../src/modules/authentication/textfile/mod_auth_textfile.so
	module ../../src/modules/filter/char/mod_filter_char.so
	module ../../src/modules/filter/libxml2/mod_filter_libxml2.so
	module ../../src/modules/filter/line/mod_filter_line.so
	module ../../src/modules/filter/textwolf/mod_filter_textwolf.so
	module ../../src/modules/filter/token/mod_filter_token.so
}
