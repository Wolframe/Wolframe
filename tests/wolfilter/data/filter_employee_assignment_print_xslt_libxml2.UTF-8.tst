...
--input-filter employee_assignment_print_map --output-filter xml:libxml2 --module ../../src/modules/filter/libxml2/mod_filter_libxml2 --program employee_assignment_print_map.xslt - 
