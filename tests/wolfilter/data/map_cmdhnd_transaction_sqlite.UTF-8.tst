...
--input-filter textwolf --output-filter textwolf --module ../../src/modules/filter/textwolf/mod_filter_textwolf -c wolframe.conf schema_select_task_by_id
**requires:TEXTWOLF
**file:wolframe.conf
LoadModules
{
	module NOTFOUND:mod_db_sqlite3test
