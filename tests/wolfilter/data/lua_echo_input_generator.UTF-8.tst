...
--input-filter xml:textwolf --output-filter xml:textwolf --module ../../src/modules/cmdbind/lua/mod_command_lua --module ../../src/modules/filter/textwolf/mod_filter_textwolf --script echo_input_generator.lua run
