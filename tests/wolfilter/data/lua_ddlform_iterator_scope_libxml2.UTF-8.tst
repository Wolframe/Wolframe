...
--input-filter xml:libxml2 --output-filter xml:libxml2 --module ../../src/modules/ddlcompiler//simpleform/mod_ddlcompiler_simpleform --form employee_assignment_print.simpleform --script ddlform_iterator_scope.lua run
