...
--input-filter xml:libxml2 --output-filter xml:libxml2 --module ../../src/modules/cmdbind/lua/mod_command_lua --module ../../src/modules/filter/libxml2/mod_filter_libxml2  --script echo_input_iterator.lua run
