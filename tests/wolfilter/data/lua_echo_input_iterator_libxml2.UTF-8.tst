...
--input-filter xml:libxml2 --output-filter xml:libxml2 --module ../../src/modules/cmdbind/luaCommandHandler/mod_lua_command_handler --module ../../src/modules/filter/libxml2/mod_filter_libxml2 --module ../../src/modules/filter//libxml2/mod_filter_libxml2 --module ../../src/modules/filter//textwolf/mod_filter_textwolf --script echo_input_iterator.lua run
**file: echo_input_iterator.lua
function run()
