...
--input-filter xml:libxml2 --output-filter xml:libxml2 --module ../wolfilter/modules//employee_assignment_convert//mod_employee_assignment_convert.so employee_assignment_convert
**output
<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
