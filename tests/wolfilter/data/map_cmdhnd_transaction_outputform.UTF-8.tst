...
--input-filter xml:textwolf --output-filter xml:textwolf --module ../../src/modules/filter/textwolf/mod_filter_textwolf  --program map_cmdhnd_transaction_outputform.simpleform --module ../../src/modules/ddlcompiler//simpleform/mod_ddlcompiler_simpleform --module ../../src/modules/normalize//number/mod_normalize_number --normalize 'int number integer(10)' --normalize 'uint number unsigned(10)' --normalize 'float number float(10,10)' --module ../../src/modules/cmdbind/directmap/mod_command_directmap --module ../wolfilter/modules/database/testtrace/mod_db_testtrace --database 'identifier=testdb,outfile=DBOUT,file=DBRES' --program=DBIN.tdl --directmap 'f=xml,c=test_transaction,n=run,o=map_cmdhnd_transaction_outputform' run
