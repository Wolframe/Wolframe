...
doc-html               build HTML version of the manual (one big html only)
doc-html-chunked       build chunked HTML version of the manual
doc-html-webpage       build chunked HTML version of the manual (for webpage)
doc-pdf                build PDF version of the manual
doc-epub               build EPUB version of the manual
