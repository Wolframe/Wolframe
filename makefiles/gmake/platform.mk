...
ifeq ($(WITH_LIBHARU),1)
ifneq ($(WITH_LOCAL_LIBHARY),1)

ifeq "$(PLATFORM)" "LINUX"

ifeq "$(LINUX_DIST)" "arch"
LIBHARU_DIR ?= /usr
LIBHARU_INCLUDE_DIR ?= $(LIBHARU_DIR)/include
LIBHARU_INCLUDE_DIRS = -I$(LIBHARU_INCLUDE_DIR)
LIBHARU_LIB_DIR ?= $(LIBHARU_DIR)/lib
LIBHARU_LIB_DIRS = -L$(LIBHARU_LIB_DIR)
LIBHARU_LIBS ?= -lhpdf
endif
