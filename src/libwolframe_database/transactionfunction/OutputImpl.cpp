...
bool TransactionFunctionOutput::Impl::skipStruct( int start, int end)
{
	bool doSkip;
...
void TransactionFunctionOutput::Impl::nextResult()
{
...
bool TransactionFunctionOutput::Impl::skipResult()
{
