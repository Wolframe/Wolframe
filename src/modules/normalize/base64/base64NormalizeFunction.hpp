...
public:
	...
	virtual types::NormalizeFunction* copy() const {return new Base64DecodeFunction(*this);}
};
...
public:
	...
	virtual types::NormalizeFunction* copy() const {return new Base64EncodeFunction(*this);}
};
