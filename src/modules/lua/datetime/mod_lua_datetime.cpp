...
{
	LuaDateTimeBuilder::constructor
};

ModuleEntryPoint entryPoint( 0, "Lua extension module for date and time arithmetic", setModuleLogger, 0, 0, NofObjects, objdef);
