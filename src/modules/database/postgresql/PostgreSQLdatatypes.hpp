...
typedef boost::uint32_t PostgresDate;
void writeDateParam( PostgresDate* res, const types::DateTime& dt);
void readDateParam( const PostgresDate* in, types::DateTime& dt);
