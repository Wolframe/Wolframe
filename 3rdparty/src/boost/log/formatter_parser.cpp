...
public:
    ...
    void push_arg(const char_type* begin UNUSED, const char_type* end UNUSED) const
    {
    ...
    void push_attr(const char_type* begin UNUSED, const char_type* end UNUSED) const
    {
