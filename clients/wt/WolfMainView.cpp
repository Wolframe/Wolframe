...
WolfMainView::WolfMainView( WContainerWidget *_parent ) : WContainerWidget( _parent )
{
...
void WolfMainView::chooseTheme( bool )
{
}

void WolfMainView::toggleDebugWindow( )
{
	south->setCollapsed( !south->isCollapsed( ) );
	menuItemDebugWindow->setChecked( !south->isCollapsed( ) );
}

void WolfMainView::enableDebugWindow( )
{
	menuItemDebugWindow->setChecked( true );
}

void WolfMainView::disableDebugWindow( )
{
	menuItemDebugWindow->setChecked( false );
}
