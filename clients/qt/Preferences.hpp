...
#define DEFAULT_APP "qtclient"
	...
	class Preferences : public QObject
	{
		...
		public:
			...
			Q_PROPERTY( bool checkSSL READ checkSSL WRITE setCheckSSL )
			bool checkSSL( ) const { return m_checkSSL; }
			void setCheckSSL( bool _checkSSL ) { m_checkSSL = _checkSSL; }
			
			Q_PROPERTY( QString clientCertFile READ clientCertFile WRITE setClientCertFile )
			...
			Q_PROPERTY( QString clientKeyFile READ clientKeyFile WRITE setClientKeyFile )
			...
			Q_PROPERTY( QString CACertFile READ caCertFile WRITE setCaCertFile )
